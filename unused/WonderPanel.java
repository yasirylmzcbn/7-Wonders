...
// /*
// * Draws the main menu, where players will either have the choice to start the
// game, or to exit
// */
...
// try {
// mainMenuBackground = ImageIO.read(new
// File("src/images/newmainmenubackground.png"));
// } catch (Exception e) {
...
// System.out.println(arg0.getX() + ", " + arg0.getY()); // mouse click
